        ...
        <div className="w-xs sm:h-50 sm:w-lg  border-3 shadow-stone-800 border-emerald-700   shadow-xl dark:text-blue-50 h-50 rounded-2xl transition-all duration-400 transform hover:-translate-y-2">
          ...
          <a href={params.links}>
            <motion.div
              ...
              className="border-1 font-sans font-semibold border-white w-35 ml-3 sm:ml-4 mt-3.5 sm:mt-7.5 rounded-2xl text-center text-lg h-8 hover:bg-amber-700 hover:cursor-pointer"
            >
              {" "}
              {"Visit now"}
            </motion.div>
