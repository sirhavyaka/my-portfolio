...
const Intro = (params) => {
  ...
  <motion.h1 
  className=" text-4xl w-lg ml-40 sm:ml-0 pl-0 sm:text-6xl mt-10 font-bold merry bg-gradient-to-r from-orange-600 to-neutral-400 via-yellow-600 bg-clip-text text-transparent"
  initial="hidden"
  animate="visible"
  variants={{
    hidden: {},
